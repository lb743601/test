...
# 提取 600x600 区域
        center_region = numpy_image[start_y:start_y + 600, start_x:start_x + 600]
...
def detect_and_draw_vertical_line(np_image):
    ...
    if lines is not None:
        ...
        if best_line is not None:
            ...
            # 找到交点
            p1,p2= find_intersections(m, b,600, 600)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if np_image is not None:
            ...
            np_image = cv2.resize(np_image, (600,600))
            ...
            if(x[0]==0):
                ...
                if(x[0]==1):
                    ...
                    if(x[2]==1):
                        number=128+int(100*x[1]/600)
                    else:
                        number=int(100*x[1]/600)
